...
\begin{landscape}
	\begin{figure}
		...
		\ganttitem{lex}{t7|-wp22}{Ordinary symbols}{Adam, Peter};
		\ganttitem{lex}{t7|-wp23}{Multiplatform deployment}{Michal};
		\ganttitem{lex}{t7|-wp24}{Benchmarking}{Marcel};
		
		
		\ganttitem{lex}{t8|-wp25}{Code coverage}{Lucia};
		
		\ganttitem{lex}{t9|-wp26}{Testing}{all};
		\ganttitem{lex}{t9|-wp27}{Documnetation}{all};
		\ganttitem{lex}{t9|-wp28}{Final presenation}{all};
