...
Each team member is responsible of delivering work packages assigned to him or her. 
	...
	\itemm \label{milestone_preview} Preview \deadline{4}
		\bwp
			...
			\itemwp Assembler checker \people{Lucia}
					\tiny validation of instruction operands in parsed statements
