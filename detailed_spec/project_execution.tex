...
Tasks were assigned to individual team members during stand ups. The tasks and their assignment \people{team member name initials in the parentheses following task name} is presented in the Gantt diagram\people{s}  \people{\ref{fig:gantt1}, \ref{fig:gantt2}, \ref{fig:gantt3}}. 
...
\bms
	\itemm Research and analysis \deadline{2}
		\bwp
			...
			\itemwp IDEs research \people{Michal}
		\eenum
