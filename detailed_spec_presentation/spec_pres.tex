...
\node[below=of b.south east, minimum width=5em, anchor=east, rotate=45] {\only<4->{ADDR $\to$}};
\node[below=of c.south east, minimum width=5em, anchor=east, rotate=45] {\only<5->{HERE $\to$}};
\end{tikzpicture}
\end{center}
