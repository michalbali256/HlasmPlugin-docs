\section{Instruction format validation}
\label{checker}
\sourceref{parser\_library/src/checking}
...
\sourcerefsu{parser\_library/src/checking/instruction\_checker.h}
...
\label{sub:asm_check}
\sourcerefsu{parser\_library/src/checking/asm\_instr\_check.h}
...
\sourcerefsu{parser\_library/src/checking/data\_definition}
