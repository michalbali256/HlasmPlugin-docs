...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{img/hlasm_context}
...
\paragraph*{Dependable} interface is implemented by a class if its instance can contain dependencies. The interface has a method to retrieve an structure holding the respective \emph{dependants}. 
