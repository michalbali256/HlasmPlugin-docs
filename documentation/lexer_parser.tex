...
\begin{itemize}
	...
	\item \TT{macro/machine/assembler/ca/model/deferred\_operand\_rules.g4} -- Concrete operand field rules. \makefileindexnotext{parser\_library/src/parsing/grammar/deferred\_operand\_rules.g4}
