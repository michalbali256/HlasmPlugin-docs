\sectionSrc{Processing manager}{processing/processing\_manager.h}
\label{chap:process}
...
\subsectionSrc{Statement Processor}{processing/statement\_processors/statement\_processor.h}
...
\subsubsectionSrc{Statement}{context/hlasm\_statement.h,processing/statement.h,semantics/statement.h}
...
\sourcerefsu{parser\_library/src/processing/statement\_processors/copy\_processor.h}
{parser\_library/src/processing/statement\_processors/macrodef\_processor.h}
...
\label{lab06:look}
\sourcerefsu{parser\_library/src/processing/statement\_processors/lookahead\_processor.h}
...
\label{ord_proc}
\sourcerefsu{parser\_library/src/processing/statement\_processors/ordinary\_processor.h}
...
\definecolor{LightGreen}{HTML}{96F97B}
...
\sourcerefsu{parser\_library/src/processing/statement\_providers/statement\_provider.h}
...
\sourcerefsu{parser\_library/src/processing/statement\_providers/copy\_statement\_provider.h}
...
\sourcerefsu{parser\_library/src/processing/opencode\_provider.h}
...
\sourcerefsu{parser\_library/src/processing/statement\_fields\_parser.h}
...
\sourcerefsu{parser\_library/src/processing/instruction\_sets}
...
\label{ca_expr:logic}
\sourcerefsu{parser\_library/src/expressions}
...
\label{ca_expr:eval}
\sourcerefsu{parser\_library/src/expressions/visitors/expression\_analyzer.h}
