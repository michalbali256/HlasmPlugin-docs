\sectionSrc{Processing manager}{parser\_library/src/processing/processing\_manager.h}
\label{chap:process}
...
\subsectionSrc{Statement Processor}{parser\_library/src/processing/statement\_processors/statement\_processor.h}
...
{parser\_library/src/processing/statement\_processors/copy\_processor.h,
...
\subsectionSrc{Statement Provider}
...
{parser\_library/src/processing/statement\_providers/copy\_statement\_provider.h,
...
{parser\_library/src/processing/opencode\_provider.h,
...
\subsubsectionSrc{CA Expressions}
{parser\_library/src/expressions}
\label{ca_expr:logic}
...
{parser\_library/src/expressions/visitors/expression\_analyzer.h,
...
\subsubsectionSrc{Machine expressions}
{parser\_library/src/expressions}
\label{mach_expr}
