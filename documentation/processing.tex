...
\label{ord_proc}
The usage of Opencode processor (in code described as Ordinary processor) can be described in the following points:
\begin{enumerate}
...
{parser\_library/src/processing/opencode\_provider.h,parser\_library/src/parser\_impl.h}
