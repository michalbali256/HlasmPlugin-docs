...
\begin{description}
	...
	\item[Processor group] \sectionFiles{.43\linewidth}{parser\_library/src/processor\_group.h} 
	...
	\item[File manager] \sectionFiles{.43\linewidth}{parser\_library/src/file\_manager.h}
...
\sectionSrc{Libraries resolution}
